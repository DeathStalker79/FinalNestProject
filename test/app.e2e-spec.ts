...
describe('AppController (e2e)', () => {
    ...
    describe('Authentication', () => {
        ...
        describe('Publishers', () => {
            ...
            it('/publishers/1 (PATCH)', async () => {
                return request(app.getHttpServer())
                    .patch('/publishers/1')
                    .set('Authorization', `Bearer ${jwtToken}`)
                    .set('Role', 'admin')
                    .send({name: 'Издательство 1 изменённое'})
                    .expect(200)
                    .expect(
                        {
                            id: 1,
                            name: 'Издательство 1 изменённое',
                        }
                    )
            });
            it('/publishers (GET)', () => {
